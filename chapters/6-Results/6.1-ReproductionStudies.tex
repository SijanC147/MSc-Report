...
A notable omission in \cite{tang2016b} as well as the reproduction carried out by \cite{moore2018} is the hidden unit count for each LSTM cell. 
...
Finally, similar to \cite{moore2018}, we ignore the reported 'softmax clipping threshold' of 200 as the implications of this remained misunderstood, and no further elaboration on the parameter is provided by \cite{tang2016b}. 
